...
# Lots of mistakes here. Should have clarified my thinking about out-of-bounds
# if I was going to insist on this approach. 4 simple for loops would have been
# simpler, I think, than this "mode management" approach.
...
class Solution:
    def spiralOrder(self, matrix: List[List[int]]) -> List[int]:
        ...
        while True:
            if curr[0] in [mode_to_oob[1], mode_to_oob[3]] or curr[1] in [
                mode_to_oob[0],
                mode_to_oob[2],
            ]:
                return out
